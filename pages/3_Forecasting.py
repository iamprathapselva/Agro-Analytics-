...
import pages.Forcasting.RainFallForecasting as RainFallForecasting
import pages.Forcasting.TemperatureForecasting as TemperatureForecasting
...
if st.session_state['my_input']=='success':
    ...
    page = st.sidebar.radio("Forcasting", ["Rainfall", "Temperature"])


    if selected_state != 'Select' and selected_district != 'Select':
        #rainfall prediction
        st.set_option('deprecation.showPyplotGlobalUse', False)
        if page=="Rainfall":
            RainFallForecasting.rainfall()
            st.pyplot()
        elif page=="Temperature":
            mae = TemperatureForecasting.temperature()
            st.pyplot()
